...
module.exports = {
  registerEmp: async (req, res) => {
    ...
    const user = new Emp({
      ...
      return res
        .status(201)
        .json({ error: false, message: "Employee created successfully" });
    } catch (err) {
      return res
        .status(500)
  ...
  editEmp: async (req, res) => {
    ...
    try {
      ...
      return res
        ...
        .json({
          error: false,
          message: "Success: Employee Information modified",
        });
    } catch (err) {
      return res
        .status(500)
  ...
  informationEmp: async (req, res) => {
    try {
      ...
      return res
        ...
        .json({
          error: false,
          message: "Success: Employee Information returned",
        });
    } catch (err) {
      return res
        .status(500)
  ...
  deleteEmp: async (req, res) => {
    try {
      ...
      return res
        .status(200)
        .json({ error: false, message: "Success: Employee have been deleted" });
    } catch (err) {
      return res
        .status(500)
        .json({ error: true, message: "Internal Servor Error" });
